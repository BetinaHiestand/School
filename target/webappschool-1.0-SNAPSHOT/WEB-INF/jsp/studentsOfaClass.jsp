...
<header>
    <h1>Students of the Class ${className} <a href="/index"><img src="/img/school.png" alt="school" height="90"></a></h1> <br>
</header>
<nav>
    <ul>
...
<br>
    <table>
        ...
        <c:forEach items = "${students}" var = "students">
            <tr>
                <td><a href="/studentdetails?studentId=${students.id}">${students.firstName}</a></td>
